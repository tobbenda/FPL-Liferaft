const sortOptions = [
  ...
  {
    attributeID: 'points_per_game',
    prettyName: 'Points pr game',
    checked: true,
  },
  { attributeID: 'form', prettyName: 'Form', checked: true },
  { attributeID: 'now_cost', prettyName: 'Current Price', checked: true },
  {
    attributeID: 'points_pr_mill',
    prettyName: 'Points pr mill',
    checked: true,
  },
  {
    attributeID: 'points_pr_game_pr_mill',
    prettyName: 'Points pr game pr mill',
    checked: true,
  },
  ...
  {
    attributeID: 'cost_change_start',
    prettyName: 'Total price change',
    checked: false,
  },
  { attributeID: 'event_points', prettyName: 'Points last GW', checked: false },
  {
    attributeID: 'goals_conceded',
    prettyName: 'Goals conceded',
    checked: false,
  },
  { attributeID: 'news', prettyName: 'News', checked: true },
  {
    attributeID: 'selected_by_percent',
    prettyName: 'Selected by percent',
    checked: false,
  },
  ...
  {
    attributeID: 'penalties_saved',
    prettyName: 'Penalties saved (Goalkeeper)',
    checked: false,
  },
  {
    attributeID: 'penalties_missed',
    prettyName: 'Penaltes missed',
    checked: false,
  },
  { attributeID: 'saves', prettyName: 'Saves (Goalkeeper)', checked: false },
  { attributeID: 'ict_index', prettyName: 'ICT-Index', checked: false },
  {
    attributeID: 'influence_rank',
    prettyName: 'Influence rank',
    checked: false,
  },
  {
    attributeID: 'influence_rank_type',
    prettyName: 'Influence rank position',
    checked: false,
  },
  {
    attributeID: 'creativity_rank',
    prettyName: 'Creativity rank',
    checked: false,
  },
  {
    attributeID: 'creativity_rank_type',
    prettyName: 'Creativity rank position',
    checked: false,
  },
  { attributeID: 'threat_rank', prettyName: 'Threat rank', checked: false },
  {
    attributeID: 'threat_rank_type',
    prettyName: 'Threat rank position',
    checked: false,
  },
  { attributeID: 'ict_index_rank', prettyName: 'ICT rank', checked: false },
  {
    attributeID: 'ict_index_rank_type',
    prettyName: 'ICT rank position',
    checked: false,
  },
  {
    attributeID: 'transfers_in_event',
    prettyName: 'GW transfers in',
    checked: false,
  },
  {
    attributeID: 'transfers_out_event',
    prettyName: 'GW trannsfers out',
    checked: false,
  },
  { attributeID: 'value_form', prettyName: 'Value form (?)', checked: false },
  { attributeID: 'status', prettyName: 'Status', checked: false },
  {
    attributeID: 'top_own_percent',
    prettyName: '% owned by top players',
    checked: true,
  },
  {
    attributeID: 'top_cap_percent',
    prettyName: '% capped by top players',
    checked: true,
  },
];
